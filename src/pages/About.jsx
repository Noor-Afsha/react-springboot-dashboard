    ...
    <div>
      ...
      <div className="bg-gradient-to-r from-green-700 to-green-500 text-white py-24 px-10 text-center">
        ...
        <h1 className="text-5xl font-bold">
          The Story of Ghar Ki Chutney
        </h1>

        <p className="mt-6 max-w-3xl mx-auto text-lg">
          At Ghar Ki Chutney, we bring the authentic taste of traditional
          homemade chutneys and pickles prepared using age-old methods.
          Every jar is crafted with love, patience, and the same recipes
          our grandmothers used in their kitchens.
        </p>
      ...
      <div className="px-10 py-20 flex flex-col md:flex-row items-center gap-16">
        ...
        <div>
          ...
          <p className="mt-6 text-gray-700 leading-relaxed">
            ...
            traditional stone grinders (sil batta). This slow grinding
            process preserves the natural oils, flavors, and aroma of the
            ingredients, giving the chutney a rich and authentic taste that
            modern machines simply cannot replicate.
          </p>

          <p className="mt-4 text-gray-700">
            Each batch is made fresh after receiving your order to ensure
      ...
      <div className="bg-green-50 py-20 px-10 text-center">
        ...
        <p className="mt-6 max-w-3xl mx-auto text-gray-700">
          We use only fresh ingredients sourced from local farms —
          mangoes, garlic, coriander, chillies, and traditional spices.
          No artificial colors, no preservatives, just natural goodness.
        </p>
